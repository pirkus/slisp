...
pub(super) fn compile_print(args: &[Node], context: &mut CompileContext, program: &mut IRProgram) -> Result<CompileResult, CompileError> {
    compile_print_like(args, false, context, program)
}

pub(super) fn compile_println(args: &[Node], context: &mut CompileContext, program: &mut IRProgram) -> Result<CompileResult, CompileError> {
    compile_print_like(args, true, context, program)
}

pub(super) fn compile_printf(args: &[Node], context: &mut CompileContext, program: &mut IRProgram) -> Result<CompileResult, CompileError> {
    if args.is_empty() {
