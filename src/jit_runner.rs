...
fn resolve_runtime_symbol(addresses: &RuntimeAddresses, symbol: &str) -> Option<usize> {
    match symbol {
        ...
        "_vector_create" => Some(slisp_runtime::_vector_create as usize),
        "_vector_clone" => Some(slisp_runtime::_vector_clone as usize),
        "_vector_count" => Some(slisp_runtime::_vector_count as usize),
        "_vector_get" => Some(slisp_runtime::_vector_get as usize),
        "_vector_slice" => Some(slisp_runtime::_vector_slice as usize),
        "_vector_to_string" => Some(slisp_runtime::_vector_to_string as usize),
        "_vector_equals" => Some(slisp_runtime::_vector_equals as usize),
        "_vector_free" => Some(slisp_runtime::_vector_free as usize),
        "_map_create" => Some(slisp_runtime::_map_create as usize),
        "_map_clone" => Some(slisp_runtime::_map_clone as usize),
        "_map_assoc" => Some(slisp_runtime::_map_assoc as usize),
        "_map_dissoc" => Some(slisp_runtime::_map_dissoc as usize),
        "_map_contains" => Some(slisp_runtime::_map_contains as usize),
        "_map_get" => Some(slisp_runtime::_map_get as usize),
        "_map_count" => Some(slisp_runtime::_map_count as usize),
        "_map_to_string" => Some(slisp_runtime::_map_to_string as usize),
        "_map_equals" => Some(slisp_runtime::_map_equals as usize),
        "_map_free" => Some(slisp_runtime::_map_free as usize),
        "_set_create" => Some(slisp_runtime::_set_create as usize),
        "_set_clone" => Some(slisp_runtime::_set_clone as usize),
        "_set_disj" => Some(slisp_runtime::_set_disj as usize),
        "_set_contains" => Some(slisp_runtime::_set_contains as usize),
        "_set_count" => Some(slisp_runtime::_set_count as usize),
        "_set_to_string" => Some(slisp_runtime::_set_to_string as usize),
        "_set_equals" => Some(slisp_runtime::_set_equals as usize),
        "_set_free" => Some(slisp_runtime::_set_free as usize),
        _ => None,
    }
}
