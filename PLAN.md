...
- **6.5 Type inference pass (planned):**
  ...
  - ⏳ **6.5.2 Constraint solving & propagation:**
    ...
    - ⏳ **6.5.2.3 Runtime helper coverage:**
      ...
      - ⏳ **6.5.2.3c Integration/validation:** Add IR-level/integration tests plus doc updates that prove the compiler takes the optimized paths and keep PLAN/Test references up to date.
